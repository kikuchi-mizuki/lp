...
def fix_invoice_item_period_correct():
    print("=== Invoice Item期間修正（正しい期間） ===")
    
    # サブスクリプションID
    subscription_id = "sub_1RpdcsIxg6C5hAVdneqtbnUG"
    invoice_item_id = "ii_1Rpv0cIxg6C5hAVdFXElqU0J"
...
if __name__ == "__main__":
    fix_invoice_item_period_correct() 