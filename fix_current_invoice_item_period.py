...
def fix_current_invoice_item_period():
    print("=== 現在のInvoice Item期間修正 ===")
    
    # サブスクリプションID
    subscription_id = "sub_1RpdcsIxg6C5hAVdneqtbnUG"
    invoice_item_id = "ii_1RpofwIxg6C5hAVdHmRxXpg6"
    ...
    try:
        ...
        if subscription.status == 'trialing':
            ...
            correct_end = trial_end + (30 * 24 * 60 * 60)  # 30日後
...
if __name__ == "__main__":
    fix_current_invoice_item_period() 