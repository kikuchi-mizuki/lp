...
"""
簡単なRailwayトークン設定スクリプト
"""

import os
import sys

def setup_railway_token_simple():
    """Railwayトークンを簡単に設定"""
    try:
        print("=== Railwayトークン簡単設定 ===")
...
if __name__ == "__main__":
    if setup_railway_token_simple():
        ...
        if test_railway_connection():
            ...
            print("2. 企業情報を入力")
            print("3. フォーム送信時にRailwayトークンが自動反映されます")
        else:
